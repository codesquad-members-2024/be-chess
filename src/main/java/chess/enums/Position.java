...
public enum Position {
    ...
    A6(Piece::createBlank), B6(Piece::createBlank), C6(Piece::createBlank), D6(Piece::createBlank), E6(Piece::createBlank),
    F6(Piece::createBlank), G6(Piece::createBlank), H6(Piece::createBlank), A5(Piece::createBlank), B5(Piece::createBlank),
    C5(Piece::createBlank), D5(Piece::createBlank), E5(Piece::createBlank), F5(Piece::createBlank), G5(Piece::createBlank),
    H5(Piece::createBlank), A4(Piece::createBlank), B4(Piece::createBlank), C4(Piece::createBlank), D4(Piece::createBlank),
    E4(Piece::createBlank), F4(Piece::createBlank), G4(Piece::createBlank), H4(Piece::createBlank), A3(Piece::createBlank),
    B3(Piece::createBlank), C3(Piece::createBlank), D3(Piece::createBlank), E3(Piece::createBlank), F3(Piece::createBlank),
    G3(Piece::createBlank), H3(Piece::createBlank),
